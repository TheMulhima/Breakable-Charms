...
{
    public const string DelicateSuffix = "_Delicate";
    public const string FragileSuffix = "_Fragile";
    public const string UnbreakableSuffix = "_Unbreakable";

    public const string RandoMod = "Randomizer 4";
